        ...
        <fieldset id="">
            <legend class="title">Velocidade</legend>        
                <div class="text">
                    <div class="line">
                        <div>Lento</div>
                        <div class="check" data-check="${velocity === 300}" data-value="300"></div>
                    </div>
                    <div class="line">
                        <div>Médio</div>
                        <div class="check" data-check="${velocity === 200}" data-value="200"></div>
                    </div>
                    <div class="line">
                        <div>Rápido</div>
                        <div class="check" data-check="${velocity === 100}" data-value="100"></div>
                    </div>
                </div>
                <div class="buttons">
                    <button value="1">
        ...
        buttons.forEach((button) => {
            button.onclick = (event) => {
                if (event.target.value === "1") {
                    const changed_velocity = Number(
                        Array.from(checks).find(
                            (check) => check.dataset.check === "true",
                        ).dataset.value,
                    )
